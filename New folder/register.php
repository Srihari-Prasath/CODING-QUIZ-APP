    ...
    <div class="w-full max-w-4xl mx-auto relative z-10">
        ...
        <div id="registerForm" class="form-container rounded-2xl shadow-xl p-8 animate-fade">
            ...
            <form class="space-y-6">
                <div class="grid-form">
                    <div>
                        <label for="departmentId" class="block text-sm font-medium text-gray-700 mb-1">Roll No*</label>
                        <input type="text" id="departmentId" class="input-field w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none" placeholder="921022205011" required>
                    </div>
                    <div>

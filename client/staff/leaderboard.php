...
<body class="min-h-screen">
    ...
    <header class="bg-white shadow-sm">
        <div class="container mx-auto px-4 py-4 flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-bold text-orange-400">IT Leaderboard</h1>
            </div>
    ...
    var color = colors[Math.floor(Math.random() * colors.length)],
        ...
        y = (initial) ? (Math.floor(Math.random() * wh)) : 0; // Changed: Start within 0 to wh for initial, 0 for new flakes
...
function move() {
    ...
    while (i--) {
        ...
        if (y > wh) { // Changed: Reset when y exceeds window height
            resetFlake(i);
        } else {
            xs[i] = x;
            ys[i] = y;
